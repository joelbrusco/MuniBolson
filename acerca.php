...
<body>
    ...
    <div class="acerca">
        <img src="multimedia/infracciones.jpg">
        <p class="parrafo">
            Se trata de identificar las ordenanzas e infracciones de tránsito para que el inspector pueda agilizar la búsqueda de los artículos correspondientes.
